...
.shipping-policy-section {
            padding: 60px 0; /* Add more space at the top and bottom */
        ...
        .shipping-policy-section .section-title {
            font-size: 2.5em;
            margin-bottom: 60px;
            text-align: center;
    ...
    <section class="shipping-policy-section">
        <div class="container">
            <div class="shipping-text">
                ...
                <p>Our commitment is to ensure swift delivery of your parcel to our valued customers. For order verification, a verification link will be sent to your mobile number. Orders will be processed once customer verification is complete.</p>
                <p>You will receive tracking details via email once your order has been shipped.</p>
                <p>For Cash on Delivery orders, kindly make the payment to the rider before opening the package.</p>
                
                <h4>Standard Delivery Timelines:</h4>
                <ul>
                    <li><strong>Karachi:</strong> 2 to 3 working days.</li>
                ...
                <p>Additional delivery charges may apply based on the location and size of the order.</p>
            </div>
        </div>
    </section>
