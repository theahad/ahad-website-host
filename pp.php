...
<div class="policy-section">
    <h2 style="text-align: center;margin-top: 50px;">PRIVACY POLICY</h2>

    <ul>
        <li>At Address Book, accessible from <a href="https://addressbook.com">https://addressbook.com</a>, we prioritize the privacy of our visitors. This document outlines what information we collect and how we use it.</li>

        <li>If you have questions about our Privacy Policy, please contact us.</li>

        <li>This policy applies to online activities on our website. It does not apply to information collected offline or through other channels.</li>

        <li>By using our website, you consent to our Privacy Policy.</li>

        <li>We collect personal information when you provide it to us directly or register for an Account.</li>

        <li>We use this information to operate, improve, and personalize our website, communicate with you, and prevent fraud.</li>

        <li>Our website uses log files and cookies to analyze trends, administer the site, and personalize content based on your preferences.</li>

        <li>We do not control third-party cookies used for advertising. Please consult their Privacy Policies for details.</li>

        <li>California residents under CCPA can request details about their data and opt-out of data sales.</li>

        <li>Under GDPR, you have rights to access, rectify, erase, restrict processing, object to processing, and data portability.</li>

        <li>We do not knowingly collect personal information from children under 13. Parents can contact us to remove such information.</li>
    </ul>
</div>
