...
/* product heading C&P*/
    ...
    max-width: 55px; /* Adjust width as needed */
    margin-top: 5px; 
    margin-left: 20px;
...
<h1 class="heading">Cosmetics & Perfumes</h1>
    ...
    while ($row = mysqli_fetch_assoc($result_query)) {
        ...
        echo "<div class='product-card'>
                ...
                <div class='product-image'>
                    <img src='./img/$product_img' alt='$ProductName'>
                </div>
                <div class='product-details'>
                    <h2>$ProductName</h2>
                    
                    <p class='card-text'>Price: $Price</p>
                    <p class='card-text'>Manufacturing Date: $ManufacturingDate</p>
                    ...
                    <button class='add-to-cart' 
                        ...
                        data-price='$Price' 
                        data-img='./img/$product_img' 
                        data-manufacturing='$ManufacturingDate' 
                        data-expiry='$ExpiryDate'>Add to Cart</button>
                </div>
            </div>";
    }
    ?>
